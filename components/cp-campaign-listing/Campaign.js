        ...
        <div className="flex flex-row items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <p className="text-sm text-[#60607B]">
              ...
              | <span className="pr-1 pl-1">Ongoing </span>
              <span className="font-semibold text-[#0D0D11] pr-2">
                12
              </span> | <span className="pr-1 pl-1">Completed </span>
              <span className="font-semibold text-[#0D0D11] pr-2">
                20
              </span> | <span className="pr-1 pl-1">Archived </span>
        ...
        <div className="flex flex-col gap-5 rounded-2xl  w-full mb-6 py-4 shadow-lg border border-gray-200 relative">
          <div className="flex flex-row flex-wrap items-center justify-between gap-4 px-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link className="btn btn-link" href={'#'}>RESET</Link>
